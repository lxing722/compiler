...
class ExpListNode extends ASTnode {
    ...
    public void typeCheck(List<Type> typeList) {
        Iterator iter1 = myExps.iterator();
        Iterator iter2 = typeList.iterator();
        while(iter1.hasNext() && iter2.hasNext()){
            ExpNode exp = (ExpNode)iter1.next();
            if(!exp.typeCheck().equals((Type)iter2.next())){
                ErrMsg.fatal(exp.lineNum(), exp.charNum(), "Type of actual does not match type of formal");
            }
        }
    }
...
class AssignNode extends ExpNode {
    ...
    public Type typeCheck() {
        ...
        Type rtype = myRhs.typeCheck();
        if(!ltype.isErrorType() && !rtype.isErrorType()){
            if((ltype.isBoolType() && rtype.isBoolType()) || (ltype.isIntType() && rtype.isIntType())){
                return rtype;
            }
            else if((ltype.isBoolType() && rtype.isIntType()) || (ltype.isIntType() && rtype.isBoolType())){
                ...
                if(ltype.isFnType()){
                    ...
                    ErrMsg.fatal(myRhs.lineNum(), myRhs.charNum(), "Function assignment");
                }
            }
                ...
                if(ltype.isStructType()){
                    ...
                    ErrMsg.fatal(myRhs.lineNum(), myRhs.charNum(), "Struct variable assignment");
                }
            }
                ...
                if(ltype.isStructDefType()){
                    ...
                    ErrMsg.fatal(myRhs.lineNum(), myRhs.charNum(), "Struct name assignment");
                }
            }
        }
...
class CallExpNode extends ExpNode {
    ...
    public Type typeCheck() {
        ...
        if(type != null && type.isFnType()){
            ...
            if(info.getNumParams() != myExpList.size()){
...
abstract class ArithmeticExpNode extends BinaryExpNode {
    ...
    public Type typeCheck() {
        ...
        if(type1.isIntType() && type2.isIntType()){
            ...
            if(type1.isIntType() && !type2.isErrorType()){
...
abstract class LogicalExpNode extends BinaryExpNode {
    ...
    public Type typeCheck() {
        ...
        if(type1.isBoolType() && type2.isBoolType()){
            ...
            if(type1.isBoolType() && !type2.isErrorType()){
